...
export const ConstructorCard = ({
    ...
    <View className="bg-black mx-4 p-4 rounded-2xl">
        <View className="flex-row justify-between">
            ...
            <View className="bg-white w-1/2 rounded-2xl items-center justify-center">
                <Image className="w-full aspect-square" source={{uri: constructorImage}}/>
            </View>
        </View>
        ...
        <View className="flex-row mb-4">
            ...
            <View className="bg-gray-500 rounded px-1">
                <Text className="text-base text-white uppercase">Bio</Text>
            </View>
        </View>
    </View>
);