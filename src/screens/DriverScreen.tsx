      ...
      <ScrollView>
        <View className="flex-row justify-between bg-black">
          <View className="justify-between p-2">
            <View className="flex-row items-center">
              ...
              <Text className="text-lg italic ml-2 text-white uppercase">
                {driver.abbr}
              </Text>
              <Text className="text-lg italic border-l border-gray-600 pl-2 ml-2 text-white uppercase">
                {driver.team.name}
              </Text>
            </View>
            <View>
              ...
              <Text className="text-4xl italic font-black text-white uppercase">
                {driver.name.split(" ")[1]}
              </Text>
            </View>
          </View>
          <Image
            source={{
              uri: driver.image ?? "https://wallpaper.dog/large/20509438.jpg",
            }}
            className="w-36 h-36"
          />
        </View>
        <View className="px-4">
          <Text className="text-2xl font-bold border-b border-gray-200 py-2.5">
            Since debut
          </Text>
          <View>
            <View className="border-b border-r rounded-b-2xl border-gray-200 mt-2.5">
              <Text className="text-base font-medium mb-2 text-gray-600">
                Podiums
              </Text>
              <Text className="text-5xl font-black italic">
                {driverStats.podiums}
              </Text>
            </View>
            <View className="border-b border-r rounded-b-2xl border-gray-200 mt-2.5">
              ...
              <Text className="text-5xl font-black italic">
                {driverStats.grands_prix_entered}
              </Text>
            </View>
            <View className="border-b border-r rounded-b-2xl border-gray-200 mt-2.5">
              <Text className="text-base font-medium mb-2 text-gray-600">
        ...
        <View className="px-4 mt-4 border-t border-gray-300">
          ...
          <Image
            source={{
              uri:
                driver.team.logo ?? "https://wallpaper.dog/large/20509438.jpg",
            }}
